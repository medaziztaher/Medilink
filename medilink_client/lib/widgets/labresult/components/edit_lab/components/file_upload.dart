...
class FileUploadEdit extends StatelessWidget {
  const FileUploadEdit({Key? key, required this.labId}) : super(key: key);
  final String labId;

  @override
  Widget build(BuildContext context) {
    return GetBuilder<EditLabController>(
      init: EditLabController(labId: labId),
      builder: (controller) {
        return Center(
          child: Column(
