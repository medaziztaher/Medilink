...
import 'package:medilink_client/widgets/allergys/add_allergy/add_allergy_controller.dart';
...
TextFormField buildtypeFormField(AddAllergyController controller) {
...
TextFormField buildfollowupStatusFormField(AddAllergyController controller) {
  return TextFormField(
...
TextFormField buildnotesFormField(AddAllergyController controller) {
  return TextFormField(
